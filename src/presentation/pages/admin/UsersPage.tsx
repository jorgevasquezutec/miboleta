...
import { useUsersStore, useTenantsStore } from "@/presentation/stores";
            ...
            <DialogFooter>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  let role: "employee" | "tenant_admin" | "platform_admin";
                  if (sel === "admin") {
                    // Admin role - if platform admin creating, make tenant_admin
                    role = isPlatformAdmin ? "tenant_admin" : "tenant_admin";
                  } else if (sel === "manager") {
                    role = "employee";
                  } else {
                    role = "employee";
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2>
                  {(tenantId ? filteredUsers : users).filter((u) => u.role === "tenant_admin" || u.role === "platform_admin").length}
                </h2>
              </div>
