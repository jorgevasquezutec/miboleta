...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
    ...
    return (
        <div className="flex border rounded-lg items-center text-sm px-1" style={{ width: 'fit-content', flexShrink: 0 }}>
            <input
                type="text"
                ref={monthRef}
                max={12}
                ...
                className="p-0 outline-none border-none text-center bg-transparent"
                style={{ width: '1.5rem', minWidth: '1.5rem', maxWidth: '1.5rem' }}
                placeholder="M"
            />
