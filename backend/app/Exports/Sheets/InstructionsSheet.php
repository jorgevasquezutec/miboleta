...
class InstructionsSheet implements FromArray, WithTitle, WithStyles, WithColumnWidths
{
    ...
    public function array(): array
    {
        return [
            ...
            ['4. org{N}_fecha_ingreso: (Opcional) Fecha de inicio laboral en esa empresa (ej: 2024-01-15)'],
            ['5. org{N}_saldo_vacaciones: (Opcional) Saldo inicial de vacaciones (en días) en esa empresa'],
            [''],
            ['IMPORTANTE:'],
